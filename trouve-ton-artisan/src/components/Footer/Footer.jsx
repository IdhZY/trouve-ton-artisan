      ...
      <div className="site-footer__inner">
        <div className="site-footer__brand">
          <Link to="/" className="site-footer__logo-link" aria-label="Accueil">
            <span className="site-footer__logo-title">
              Trouve ton artisan !
            </span>
            <span className="site-footer__logo-subtitle">
          ...
          <address className="site-footer__address">
            ...
            <br />
            France —{" "}
            <a href="tel:+33426734000" className="site-footer__tel">
              +33 (0)4 26 73 40 00
            </a>
          </address>
        </div>
        <nav className="site-footer__nav" aria-label="Liens légaux">
          <ul className="site-footer__nav-list" role="list">
            <li>
              <Link to="/mentions-legales" className="site-footer__nav-link">
                Mentions légales
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link to="/accessibilite" className="site-footer__nav-link">
                Accessibilité
              </Link>
            </li>
            <li>
              <Link to="/cookies" className="site-footer__nav-link">
                Cookies
              </Link>
            </li>
          </ul>
